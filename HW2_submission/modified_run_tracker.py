# This script is almost the same as the script run_tracker.py with only one difference that it has a 'for' loop which
# runs over all video sequences we have selected for test, tests our mean-shift algorithm on them. To also the results
# we mention in the report for alpha equal to 0.1, change the constant in line 38 of the file ms_tracker.py.
...
sequences = ['bolt', 'basketball', 'sphere', 'ball', 'polarbear', 'david']
for seq in sequences:
    # set the path to directory where you have the sequences
    dataset_path = os.getcwd()  # TODO: set to the dataet path on your disk
